...
class My_booking extends CI_Controller
{
    ...
    public function leave_review()
    {
        ...
        $this->email->subject('Welcome to bananacampers');
        $this->email->message(
        '<table border="0" cellpadding="0" cellspacing="0" width="100%">
        	<tr>
        	<td align="center" bgcolor="#e9ecef">      
        	...
        	<td align="center" bgcolor="#e9ecef">       
        		...
        		<tr>
        			<td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: Source Sans Pro, Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
        			<p style="margin: 0;">Your client have left the review for his rental</p>
        			</td>
        		</tr>
        		<tr>
        			<td align="left" bgcolor="#ffffff">
        			<table border="0" cellpadding="0" cellspacing="0" width="100%">
        				...
        				<td align="center" bgcolor="#ffffff" style="padding: 12px;">
        					...
        					<tr>
        						<td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
        						<a href="http://bananacampers.pt/index.php/My_ads" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: Source Sans Pro, Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">View Review</a>
        						</td>
        					</tr>
        					</table>
        				</td>
