...
<style>
    ...
    background: 0;  color: #ccffcc; cursor: default; }
        ...
        <div class="col-12 col-md-8">
            ...
            <div class="row">
                ...
                <div class="col-8 col-sm-10">
                    ...
                    <?php echo $user_info->first.'\'s '.$ads->chassis_brand.' '.$ads->chassis_model; ?></b></label>
            ...
            <div class="row"> 
                <div class="col-1"></div>
                <div class="col-11"><h6>=<?php echo $this->lang->line('dri');?>=</h6></div>
            </div><br>
            <div class="row">
            ...
            <div class="row">
                <div class="col-1"></div>
                <div class="col-11"><h6>=<?php echo $this->lang->line('life');?>=</h6></div>
            </div><br>
            <div class="row">
            ...
            <div class="row">
                <div class="col-1"></div>
                <div class="col-11"><h6>=<?php echo $this->lang->line('kitchen');?>=</h6></div>
            </div><br>
            <div class="row">
                <?php if($eqps->Sink==1){ ?>
                <div class="col-4">
            ...
            <div class="row">
                <div class="col-1"></div>
                <div class="col-11"><h6>=<?php echo $this->lang->line('bath');?>=</h6></div>
            </div><br>
            <div class="row">
            ...
            <div class="row">
                <div class="col-1"></div>
                <div class="col-11"><h6>=<?php echo $this->lang->line('out');?>=</h6></div>
            </div><br>
            <div class="row">
            ...
            <div class="row">
                <div class="col-1"></div>
                <div class="col-11"><h6>=<?php echo $this->lang->line('auto');?>=</h6></div>
            </div><br>
            <div class="row">
        ...
        <div class="col-12 col-md-4 ">
            ...
            <div class="row border_show">
                ...
                <div class="prtg">
                    ...
                    <p><b><?php echo $this->lang->line('day');?>:</b> <span id="perday_pr"></span></p>
...
<script>
    ...
    var perday,allday,service_fee,total,startdate,enddate;
